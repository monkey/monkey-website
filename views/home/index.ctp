  ...
  <div class="row-fluid" style="text-align:center">
    <div class="span5">
      <a class="btn btn-warning btn-large"
         href="http://monkey-project.com/releases/1.5/monkey-1.5.3.tar.gz">
        <i class="icon-white icon-download-alt"></i>
        Download Monkey v1.5.3
      </a>
    </div>
    <div class="span3">
...
<div class="row-fluid">
  <div class="span11">
    <h3>Latest release: v1.5.3 (Emperor Tamarin)
      <small>on Saturday 16th, Aug 2014</small>
    </h3>
    <p>
      Monkey project development team, is proud to announce the availability
      of <i>Monkey v1.5.3</i> release. For more details about it, please refer to the
...
<div class="row-fluid">
  <div class="span11">
    ...
    <pre>$ wget http://monkey-project.com/releases/1.5/monkey-1.5.3.tar.gz
