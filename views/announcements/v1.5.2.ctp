...
<h2>Monkey HTTP Server v<?=$VERSION?> <small>2014-07-18</small></h2>
<p>
...
<h3>Introduction</h3>
<p>
  We are proud to announce the availability of the minor fix release <i>Monkey v1.5.2</i>,
...
<p>
  Here is a list of the most relevant changes on Monkey v1.5.2:
<ul>
  <li>Signal: restore handler for SIGPIPE</li>
  <li>HTTP: on using API sendfile, check EAGAIN</li>
  <li>HTTP: If-Modified-Since now allow clients from the future</li>
  <li>Mimetype: add SVG types (fix #153)</li>
  <li>Help: add missing break line on text</li>
</ul>
