...
<h2>Monkey HTTP Daemon v<?=$VERSION?> <small>2013-06-21</small></h2>
...
<h3>Introduction</h3>
<p>
  We are very proud to announce the availability of a new fix release <i>Monkey v1.2.2</i>, codename <b>Expresso</b>.
  This version comes with important security fixes.
</p>
<br>
  <h3>What is new ? What has changed ?</h3>
<p>
  Here is a list of the most relevant changes on Monkey v1.2.2:
<ul>
  <li>HTTP: Fix possible DoS when using HTTP ranges</li>
  <li>Basic Auth: fix and validate length of user entries</li>
  <li>Basic Auth: fix buffer overflow when loading user file</li>
  <li>Basic Auth: fix possible segfault when base64_decode fails</li>
</ul>
