...
<h3>Introduction</h3>
<p>
  We are very proud to announce the availability of a new fix release <i>Monkey v1.2.1</i>, codename <b>Expresso</b>.
  This version fix a bug in the headers parser that can lead to a DoS.
</p>
<br>
  <h3>What is new ? What has changed ?</h3>
<p>
  Here is a list of the most relevant changes on Monkey v1.2.1:
<ul>
  <li>Fix potencial DoS bug in headers parser.
</ul>
