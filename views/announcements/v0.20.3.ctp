...
<h2>Monkey HTTP Daemon v<?=$VERSION?> <small>2011-10-12</small></h2>
...
<ul>
  <li>Liana_SSL: auto-unload if the plugin is not being used as transport layer</li>
  <li>Debian: add debian rules to build packages :)</li>
</ul>
...
<ul>
    <li><u>Jonathan Gonzalez (Zeus)</u>: review the Debian packaging rules and help with packages deployment</li>
</ul>
