...
<h2>Monkey HTTP Server v<?=$VERSION?> <small>2014-10-16</small></h2>
<p>
...
<h3>Introduction</h3>
<p>
  We are proud to announce the availability of the minor fix release <i>Monkey v1.5.4</i>,
...
<p>
  Here is a list of the most relevant changes on Monkey v1.5.4:
<ul>
  <li>Scheduler: optimization when timing out connections (fix #171)</li>
  <li>Scheduler: Close connection after MK_PLUGIN_STAGE_10</li>
  <li>Virtual Host: validate dummy files (Fix #155)</li>
  <li>Scheduler: on timeout, validate incomplete linked list (#163)</li>
  <li>Kernel: support Debian version format</li>
  <li>Header: when using Chunked encoding, do not set Content-Length</li>
</ul>
