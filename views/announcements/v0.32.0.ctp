<?
$VERSION = "0.32.0";
$FILES =  "http://monkey-project.com/releases/0.32/";
?>

<div class="hero-unit">

<h2>Monkey HTTP Daemon v<?=$VERSION?> <small>2012-02-09</small></h2>
...
<ul>
  <li>Monkey workers now have names (e.g: ps -L -p PID)</li>
  <li>Debian: updated rules to ditribute Monkey default html</li>
  <li>Fix: configure script now distribute plugins scripts</li>
  <li>Cheetah now works in server mode by default</li>
  <li>Depreated ip_str plugin struct field</li>
  <li>API: drop unnecesary casts</li>
</ul>
...
<ul>
    <li><u>No contributors on this release</u></li>
</ul>
