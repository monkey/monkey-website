...
<h2>Monkey HTTP Daemon v0.13.2 has been released</h2>
<p>
...
<h3>Introduction</h3>
<p>
   Monkey project team, is proud to announce the availability of our minor release <i>Monkey HTTP Daemon 0.13.2</i>. This new release comes with some fixes for the build system and
plugins.
</p>
...
<ul>
   ...
   <li>Fix #51: Cannot set to non-blocking the socket when compiled with ACCEPT_GENERIC</li>
   <li>Configure: improved configure script to generate Makefiles</li>
   <li>Mandril: fix bad usage of str_build()</li>
   <li>Cheetah: fix broken Makefile.in</li>
   <li>Palm: fix compilation issues</li>
</ul>
</p>
...
<ul>
        ...
        <li>Alexander Stiehl (Taorat)</li>
        <li>Pier Gaston (pgas)</li>
</ul>
