...
<h2>Monkey HTTP Server v<?=$VERSION?> <small>2014-10-18</small></h2>
<p>
...
<h3>Introduction</h3>
<p>
  We are proud to announce the availability of the minor fix release <i>Monkey v1.5.5</i>,
...
<p>
  Here is a list of the most relevant changes on Monkey v1.5.5:
<ul>
  <li>HTTP: add extra validation when removing request from the incomplete list</li>
</ul>
