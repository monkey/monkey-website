<?
$VERSION = "0.33.0";
$FILES =  "http://monkey-project.com/releases/0.33/";
?>
...
<h2>Monkey HTTP Daemon v<?=$VERSION?> <small>2012-02-20</small></h2>
...
<p>
  ...
  This new release comes with a minor fix.
</p>
...
<ul>
  <li>Config: fix little bug in vhost reader</li>
  <li>Liana_SSL: Count <a href="http://goo.gl/46bWl">number of bazingas</a>
</ul>
...
<ul>
  <li><u>Felipe Reyes (freyes on freenode), he reported the vhost issue</u></li>
</ul>
