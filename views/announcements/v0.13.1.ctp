...
<h2>Monkey HTTP Daemon v0.13.1 has been released</h2>
<p>
...
<h3>Introduction</h3>
<p>
   Monkey project team, is proud to announce the availability of our new major release <i>Monkey HTTP Daemon 0.13.1</i>. This new release comes with improved performance and
   minor fixes.
</p>
...
<p>
<ul>
   <li>Ticket #33: add configuration directory support for plugins. Keys auto-replace</li>
   <li>Performance improved in string manipulation and header response</li>
   <li>Changed default MaxKeepAliveRequest value</li>
   <li>Fix: banana script now use right pidfile</li>
</ul>
</p>
