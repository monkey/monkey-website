...
>int event_add(int sockfd, struct plugin *handler, struct client_request *cr, struct request *sr)</PRE
></DIV
><DIV
CLASS="sect2"
><H2
...
><A
NAME="AEN424"
>5.2.2. _mkp_event_read()</A
></H2
><P
>This hook function, is invoked when the file descriptor has some data ready to be read.</P
><PRE
CLASS="programlisting"
>int _mkp_event_read(struct client_request *cr, struct request *sr)</PRE
></DIV
><DIV
CLASS="sect2"
><H2
...
><A
NAME="AEN428"
>5.2.3. _mkp_event_write()</A
></H2
><P
>This hook function, is invoked when the file descriptor is ready to receive data.</P
><PRE
CLASS="programlisting"
>int _mkp_event_write(struct client_request *cr, struct request *sr)</PRE
></DIV
><DIV
CLASS="sect2"
><H2
...
><A
NAME="AEN432"
>5.2.4. _mkp_event_close()</A
></H2
><P
>This hook function, is invoked when the file descriptor has been closed.</P
><PRE
CLASS="programlisting"
>int _mkp_event_close(struct client_request *cr, struct request *sr)</PRE
></DIV
><DIV
CLASS="sect2"
><H2
...
><PRE
CLASS="programlisting"
>int _mkp_event_error(struct client_request *cr, struct request *sr)</PRE
></DIV
><DIV
CLASS="sect2"
><H2
...
><PRE
CLASS="programlisting"
>int _mkp_event_timeout(struct client_request *cr, struct request *sr)</PRE
></DIV
></DIV
><DIV
CLASS="NAVFOOTER"
