...
NAME="architecture"
></A
>Chapter 4. Server Architecture</H1
><DIV
CLASS="sect1"
><H1
CLASS="sect1"
...
><P
>&#13;  In a Plugin context, exists two sets of functions: 'api functions' and 'hook functions'.
  API functions are provided through the <TT
CLASS="filename"
>plugin_api</TT
> structure passed to the plugin on startup when the _mkp_init() hook function is invoked. This structure contains the API functions to handle strings, events, 
  memory and others.
</P
><P
